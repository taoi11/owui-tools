...
class Tools:
    ...
    async def sub_agent(
        ...
        :param model: One of the following `sonnet-3.7` - Code generation tasks; `r1-1776` - Deep thoughtful reasoning; `sonar` - Grounded by internet search. Fact-checking and fresh knowledge based tasks; `sonar-pro` - Same as sonar but with multi-step web research.
        """
